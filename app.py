...
# Logging configuration (configured in config.py but useful here)
logging.basicConfig(
    level=logging.INFO,
...
def create_app():
    ...
    app.router.add_get('/favicon.ico', proxy.handle_favicon) # ✅ Favicon Route
    
    # ✅ Static Files Route (with absolute path and auto-creation)
...
def main():
    ...
    if sys.platform == 'win32':
        # Silence asyncio logger to avoid ConnectionResetError spam
